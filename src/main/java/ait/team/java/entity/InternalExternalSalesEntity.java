...
@Entity
@Table(name = "m_internal_external_sales", schema = "public")
public class InternalExternalSalesEntity implements Serializable {
     ...
     */
    @Id
    @Column(name = "internal_external_sales_code", nullable = false, length = 1)
    private String internalExternalSalesCode;

    /**
     * àOÌæª¼
     */
    @Column(name = "internal_external_sales_name", length = 40)
