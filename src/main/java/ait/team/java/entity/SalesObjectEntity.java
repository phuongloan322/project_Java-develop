...
@Entity
@Table(name = "m_sales_object", schema = "public")
public class SalesObjectEntity implements Serializable {
     ...
     */
    @Id
    @Column(name = "sales_object_code", nullable = false, length = 3)
    private String salesObjectCode;

    /**
     * ãÈÚ¼
     */
    @Column(name = "sales_object_name", length = 40)
